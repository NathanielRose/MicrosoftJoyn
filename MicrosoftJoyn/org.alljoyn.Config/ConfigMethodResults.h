...
public:
    ...
    property Windows::Foundation::Collections::IMap<Platform::String^,Platform::Object^>^ OutputArg
    {
        Windows::Foundation::Collections::IMap<Platform::String^,Platform::Object^>^ get() { return m_interfaceMemberOutputArg; }
    internal:
        void set(_In_ Windows::Foundation::Collections::IMap<Platform::String^,Platform::Object^>^ value) { m_interfaceMemberOutputArg = value; }
    }
    
    static ConfigGetConfigurationsResult^ CreateSuccessResult(_In_ Windows::Foundation::Collections::IMap<Platform::String^,Platform::Object^>^ interfaceMemberOutputArg)
    {
...
private:
    int32 m_status;
    Windows::Foundation::Collections::IMap<Platform::String^,Platform::Object^>^ m_interfaceMemberOutputArg;
};
